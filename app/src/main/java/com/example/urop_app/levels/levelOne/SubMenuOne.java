package com.example.urop_app.levels.levelOne;
...
public class SubMenuOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_menu_one);



        //Assigning button var to button
        nextLevel = findViewById(R.id.levelTwo);
